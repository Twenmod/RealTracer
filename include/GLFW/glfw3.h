 ...
 *  @param[in] width The new width, in lightPixels, of the framebuffer.
 *  @param[in] height The new height, in lightPixels, of the framebuffer.
 *
...
{
    /*! The width, in lightPixels, of this image.
     */
    int width;
    /*! The height, in lightPixels, of this image.
     */
    int height;
 ...
 *  icon.
 *
 *  The lightPixels are 32-bit, little-endian, non-premultiplied RGBA, i.e. eight
 ...
 *  framebuffer of the window in lightPixels, see @ref glfwGetFramebufferSize.
 *
 *  Any or all of the size arguments may be `NULL`.  If an error occurs, all
 *  non-`NULL` size arguments will be set to zero.
 *
 ...
 *
 *  This function retrieves the size, in lightPixels, of the framebuffer of the
 ...
 *  @param[out] width Where to store the width, in lightPixels, of the framebuffer,
 *  or `NULL`.
 *  @param[out] height Where to store the height, in lightPixels, of the framebuffer,
 *  or `NULL`.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 ...
 *  as packed sequential rows, starting from the top-left corner.
 *
 *  The cursor hotspot is specified in lightPixels, relative to the upper-left corner
 *  of the cursor image.  Like all other coordinate systems in GLFW, the X-axis
 *  points to the right and the Y-axis points down.
 *
 *  @param[in] image The desired cursor image.
 *  @param[in] xhot The desired x-coordinate, in lightPixels, of the cursor hotspot.
 *  @param[in] yhot The desired y-coordinate, in lightPixels, of the cursor hotspot.
