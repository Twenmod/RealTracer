...
public:
	...
	virtual void Trace(std::vector<Vec3>& colorOut, std::vector<Vec3>& normalOut, float _deltaTime) = 0; // Handles drawing of the screen should fill in pixelcolors and normals
